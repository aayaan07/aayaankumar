...
const Navbar = () => {
  ...
  return (
    <>
      ...
      {overlay && (
        <div
          className="absolute flex flex-col xl:pl-[200px] pt-[100px] w-screen h-screen bg-[url('https://i.ibb.co/CsSZSsJ4/noise-bg.png')] bg-cover top-0 left-0 text-[var(--primary)] text4xl z-10 space-y-5 overflow-hidden"
          id="overlayMenu"
        >
          <IoIosClose
            onClick={close}
          ...
          <div className="w-[500px] h-[250px] bg-[var(--secondary)] rounded-lg mt-[60px] musicBox navItem hidden xl:block relative">
            {video ? (
              ...
              <div className="w-fit mx-auto h-full flex flex-col items-center justify-center text-center Poppins text-3xl text-white font-bold max-w-[75%] cursor-pointer" onClick={() => setVideo(true)}>
                ...
                <span className="text-white/60 font-normal text-base">Disclaimer: Lower your volume to 30% or 40% before clicking</span>
              </div>
            )}
          </div>
        </div>
